...
<table class="form-table deploymintTable">
  <tr>
    ...
    <td>
      <select id="sdDepSnapshot" name="name" onchange="deploymint.updateSnapDesc(<?php echo $proj['id'];?>, jQuery(this).val());return true;">
      {{if snapshots.length}}
      ...
      <a href="javascript:void(0)" name="archiveSnapshot">archive this snapshot</a>
    </td>
  </tr>
  <tr>
    <td>Currently selected snapshot description:</td>
    <td>
      <textarea rows="5" cols="50" style="width:550px;height:200px;" id="sdSnapDesc2" readonly="readonly"></textarea>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
      <select id="sdDepBlog" name="blogid">
      {{each(i,blog) blogs}}
