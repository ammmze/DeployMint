...
<div class="wrap">
  ...
  <p style="width:500px;">
    <b style="color:#F00;">Only to be used in emergencies. This will overwrite
      your entire Wordpress MU Network of blogs and revert it to the state it
      was in when the backup was taken.</b>
    This is a list of recent deployments. Each time we deploy, we make a full
    backup of your entire Wordpress database.
    If for some reason a deployment goes awry, you can revert to your original
    pristine database by clicking "Revert" below.
    <br />
    <br />
    <b>NOTE:</b> Reverting to a previous database will blow away any comments, blog
    entries, pages, stats or any other data created since you deployed. The only
    data that is preserved is the data of the DeployMint system itself.
  </p>
  <p>
<?php if( count( $dbs ) ){ ?>
